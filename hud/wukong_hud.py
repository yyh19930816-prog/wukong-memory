    ...
    def _api(self, msg):
        ...
        try:
            ...
            sys_prompt = (
                ...
                "9. 老板让你研究/分析/查资料某个话题 → 调用 deep_research，这会自动搜多个角度\n\n"
                "【deep_research 使用时机】\n"
                "以下情况必须用 deep_research 而不是 search_web：\n"
                "- '帮我研究一下XXX' / '分析一下XXX' / '查一查XXX行业'\n"
                "- '给我一份关于XXX的报告' / '了解一下竞争对手XXX'\n"
                "- '这个博主/品牌/公司怎么样' （需要多角度了解）\n"
                "deep_research 会自动搜3-5个角度，给你整合后的完整信息，比单次搜索全面10倍\n\n"
                "【工具失败时的铁律】\n"
